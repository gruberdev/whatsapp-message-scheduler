...
echo "URL: https://whatsapp-message-scheduler-grb086ecp-dibpuelmas-projects.vercel.app"
FRONTEND_STATUS=$(curl -s -o /dev/null -w "%{http_code}" "https://whatsapp-message-scheduler-grb086ecp-dibpuelmas-projects.vercel.app")
...
echo ""
echo "📱 Access your app: https://whatsapp-message-scheduler-grb086ecp-dibpuelmas-projects.vercel.app"
